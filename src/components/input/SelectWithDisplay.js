...
import { SVG_CLOSE_GRAY, SVG_ARROW_DOWN } from '../../assets/Asset';
...
const Dropdown = props => {
    let { disabled, options, type, onChanged, value, placeholder, id, hideClearIcon, isEmployeeSelection, isMultiple } = { ...props };
    // React Hook
    ...
    */
    ...
    return (
        <Fragment>
                        ...
                        disabled ? (
                            <div data-testid={'dropdown-icon'} className="e-input-icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M5.4 6L4 7.51351L10 14L16 7.51351L14.6 6L10 10.973L5.4 6Z" fill="#A0AEC0" />
                                </svg>
                            </div>
                        ) : (
            ...
            <Popover id="select-popover" className={Boolean(dropdownPopover) ? 'open-popover' : ''} open={Boolean(dropdownPopover)} onClose={event => popoverRequestHandler(event, 'on-blur')}>
                                    ...
                                    type === 'select' ? (
                                        ...
                                        <Fragment>
                                            {/* <div className="e-select-all">
                                                {
                                                    isMultiple && optionsArray.length > 1 ? (
                                            ...
                                            <div className="e-select-checklist">
                                                {
                                                    optionsArray.map((opt, idx) => (
                                                        <div id='option-div' data-testid="multi-select-option-div" key={idx} onClick={event => optionSelectionHandler(event, opt)}>
